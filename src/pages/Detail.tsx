import { IonAvatar, IonContent, IonHeader, IonItem, IonLabel, IonPage, IonTitle, IonListHeader,IonToolbar,IonList,IonCardHeader,IonCardSubtitle,IonCardTitle,IonCard,IonCardContent, IonRow,IonGrid,IonCol,IonImg,IonCheckbox,IonToggle,IonInput,IonText } from '@ionic/react';
...
const Detail: React.FC = () =>{
    ...
    function getClassNameHeader(signalement){
            ...
            <IonContent fullscreen>
                <IonGrid>
                        <IonListHeader className={getClassNameHeader(signalement)}>
                            <IonTitle >{signalement!==undefined ?signalement.type['nom']+" du": ""} {signalement!==undefined ?signalement.date.slice(0,10):""}</IonTitle>
                        </IonListHeader>
                        <IonList>
                            <IonItem>
                                <IonGrid>
                                    <IonRow>
                                        <IonCol size="4" className="text-style">Region:</IonCol>
                                        <IonCol size="8">{signalement==undefined || signalement.region==null ? "Non défini": signalement.region}</IonCol>
                                    </IonRow>
                                </IonGrid>
                            </IonItem>
                            <IonItem className="div-desc">
                                <IonGrid className="div-desc">
                                    <IonRow className="div-desc">
                                        <IonCol size="4" className="text-style">Description:</IonCol>
                                        <IonCol size="8">
                                                <div className="div-desc">
                                                    <IonText>{signalement==undefined || signalement.description==null ? "-" : signalement.description}</IonText>
                                                </div>
                                            </IonCol>
                                    </IonRow>
                                </IonGrid>
                            ...
                            <IonItem>
                                <IonGrid>
                                    <IonRow>
                                        <IonCol size="4" className="text-style">Etat actuel:</IonCol>
                    ...
                    <IonListHeader className="header-image">
                        ...
                        <IonGrid>
                            <IonRow>
                                {signalement==undefined? "Aucune image":signalement.photos.map((p,i)=>(
                                    
                                    <IonCol size="4" key={i} className={(i+1)%3!==0 ? 'image' : 'image'}>
                                        <IonImg src={p}/>
                                    </IonCol>
                                ))}
